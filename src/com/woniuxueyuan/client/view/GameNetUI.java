...
import com.woniuxueyuan.common.entity.Chess;
 ...
 */
public class GameNetUI extends Stage { // 应用程序窗口
  private static final GameNetUI INSTANCE = new GameNetUI();
  // 1. 创建一个面板
  Pane pane;
  String name;
  ...
  public static GameNetUI getInstance() {
    return INSTANCE;
  }
  ...
  public void init() {
    {
      ...
      this.setScene(scene);
      label = JavaFXUtil.getTextLabel("玩家" + name, 0, 0, 100);
